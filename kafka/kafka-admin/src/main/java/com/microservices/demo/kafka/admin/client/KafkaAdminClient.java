...
import com.microservices.demo.kafka.admin.exceptions.KafkaAdminExceptions;
...
public class KafkaAdminClient {
    ...
    public void createTopics() {
        ...
        try {
            ...
            throw new KafkaAdminExceptions("Reached max no of retry attempts for creating Kafka topics", t);
        }
    ...
    private void sleep(Long sleepTimeMs) {
        try {
            ...
            throw new KafkaAdminExceptions("Error while sleeping");
        }
    }

    private void checkMaxRetry(int retry, Integer maxRetry) {
        if(retry > maxRetry){
            throw new KafkaAdminExceptions("Too many retry attempts");
        }
    }
    ...
    private Collection<TopicListing> getTopics() {
        ...
        try {
            ...
            throw new KafkaAdminExceptions("Reached max number of retry for reading kafka topics", e);
        }
        return topics;
    }
